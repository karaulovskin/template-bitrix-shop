            ...
            <div class="slider-catalog__container swiper-container">
                <div class="slider-catalog__wrapper swiper-wrapper">
					<?foreach($arResult['ITEMS'] as $i => $arItem):?> 
						...
						if($arItem["PROPERTIES"]["PERECHERKNUTAYA_TSENA"]["VALUE"] > $price && $price>0){
							$proc = round(($arItem["PROPERTIES"]["PERECHERKNUTAYA_TSENA"]["VALUE"]-$price) / $arItem["PROPERTIES"]["PERECHERKNUTAYA_TSENA"]["VALUE"] * 100);
						}
						else $proc = false;	
	                    ...
	                    <div class="slider-catalog__slide swiper-slide" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
	                        <div class="catalog-item">
	                            <div class="icon-info-list">
		                            ...
		                            <?endif;?>                           
	                                <?if($proc > 0 && $arItem["PROPERTIES"]["PERECHERKNUTAYA_TSENA"]["VALUE"] > 0):?>
		                                <div class="icon-info-list__item">
	                            ...
	                            <div class="catalog-item__bottom">
	                                <div class="catalog-item-price">
	                                	<?if($price>0):?>
	                                		<?if($arItem["PROPERTIES"]["PERECHERKNUTAYA_TSENA"]["VALUE"] > $price && $arItem["PROPERTIES"]["PERECHERKNUTAYA_TSENA"]["VALUE"]>"0"):?>
		                                  		 <div class="catalog-item-price__value catalog-item-price__value--sale"><?=$arItem["PROPERTIES"]["PERECHERKNUTAYA_TSENA"]["VALUE"];?> р</div>
