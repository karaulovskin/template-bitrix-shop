...
if ($normalCount > 0):
?>
<div class="basket-items-list" id="basket_items_list">
	<div class="bx_ordercart_order_table_container">
		<table class="basket-items-list-table" id="basket_items">
			<tbody>
				<?
				...
				foreach ($arResult["GRID"]["ROWS"] as $k => $arItem):
					...
					?>
					<tr  class="basket-items-list-item-container" id="<?=$arItem["ID"]?>"
									...
									<?dump($arItem);?>
                                        <div class="basket-item-block-image">
                                            <a href="<?=$arItem["DETAIL_PAGE_URL"] ?>" class="basket-item-image-link">
                                                <img class="basket-item-image" alt="" src="./images/content/toy.png">
                                            </a>
                                        </div>
									</div>
								</td>
