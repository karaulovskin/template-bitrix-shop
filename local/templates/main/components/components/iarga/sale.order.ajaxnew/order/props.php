...
?>	
	...
	if (is_array($arResult["ORDER_PROP"]["USER_PROFILES"]) && !empty($arResult["ORDER_PROP"]["USER_PROFILES"])):
		...
		?>
			<p class="h2 box100"><?=GetMessage("SOA_TEMPL_PROP_CHOOSE")?></p>
	...
	?>
	<!--<div id="sale_order_props" <?=($bHideProps && $_POST["showProps"] != "Y")?"style='display:none;'":''?> class="item flex">-->
	<div <?=($bHideProps && $_POST["showProps"] != "Y")?"style='display:block;'":''?> class="item flex">
		<?
