						...
						function submitForm(val, valid)
						{
							...
							if (valid) {
                                        ...
                                        case 'CITY':
                                            if ($this.val() == "") {
                                                ...
                                                $this
                                                    .addClass('invalid')
                                                    .closest('label')
                                                    .append("<span class='error-tooltip'>Укажите Город</span>");
                                        ...
                                        case 'LAST_NAME':
                                            if ($this.val() == "") {
                                                ...
                                                $this
                                                    .addClass('invalid')
                                                    .closest('label')
                                                    .append("<span class='error-tooltip'>Укажите Фамилию</span>");
                                        ...
                                        case 'NAME':
                                            if ($this.val() == "") {
                                                ...
                                                $this
                                                    .addClass('invalid')
                                                    .closest('label')
                                                    .append("<span class='error-tooltip'>Укажите Имя</span>");
                                        ...
                                        case 'EMAIL':
                                            ...
                                            if ($this.val() == "") {
                                                ...
                                                $this
                                                    .addClass('invalid')
                                                    .closest('label')
                                                    .append("<span class='error-tooltip'>Укажите email</span>");
                                        ...
                                        case 'UF_INN':
                                            if ($this.val() == "") {
                                                ...
                                                $this
                                                    .addClass('invalid')
                                                    .closest('label')
                                                    .append("<span class='error-tooltip'>Укажите ИНН</span>");
                                                t = false;
                                ...
                                if (!$('#ORDER_FORM .checkbox--required').prop("checked")) {
                                    ...
                                    $('#ORDER_FORM .checkbox--required')
                                        .addClass('invalid')
                                        .closest('label')
                                        .append("<span class='error-tooltip'>Обязательное поле</span>");
                                    t = false;
