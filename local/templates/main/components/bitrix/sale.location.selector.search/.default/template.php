...
<?else:?>
	...
	<div id="sls-<?=$arResult['RANDOM_TAG']?>">
		...
		<?endif?>
		<label class="label bx-ui-sls-input-block">
			<input type="text" autocomplete="off" name="<?=$arParams['INPUT_NAME']?>" value="<?=$arResult['VALUE']?>" class="dropdown-field city-ajax" placeholder="<?=Loc::getMessage('SALE_SLS_INPUT_SOME')?> ..." />
