		...
		)
		{
			...
			<div class="row">
				<div class="col-xs-12"> 
					...
					<?else:?>
			            <div class="basket-checkout-section">
			                <form action="/local/inc/ajax/auth.php" data-form data-form-open-form-sms data-ajax-url="/local/inc/ajax/auth.php">
			                    <div class="basket-checkout-section-inner">
			                        <div class="form-row">
			                            <div class="form-col">
			                                <label class="label">
			                                    <input type="text" name="phone" class="input" data-inputmask data-input-required="phone" placeholder="Телефон">
			                                </label>
			                            </div>
			                        </div>
